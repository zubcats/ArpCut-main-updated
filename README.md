...
For paid builds with strict local license signature verification, set repository secret `PAID_LICENSE_PUBLIC_KEY_B64` (public verify key from License Manager).

...
class TestDupeStatusLogging(unittest.TestCase):
    ...
    def test_dupe_uses_visible_inline_status(self) -> None:
        ...
        self.assertIn('def _dupe_cut_still_active', src)
        self.assertIn('drop_from_victim', method_src('_dupe_cut_still_active'))
        self.assertNotIn('_unkill_relays', method_src('_dupe_cut_still_active'))

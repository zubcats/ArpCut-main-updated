...
SETTINGS_KEYS = [
    ...
    'mitm_adv_loss_out',
    'mitm_adv_loss_pct',
    # Per-impairment schedule (Tm = timer gate, ms = ON phase length, Loop = repeat forever, count = ON pulses if not loop).
    'mitm_adv_delay_timer_on',
    'mitm_adv_delay_timer_ms',
    'mitm_adv_delay_timer_loop',
    'mitm_adv_delay_timer_count',
    'mitm_adv_jitter_timer_on',
    'mitm_adv_jitter_timer_ms',
    'mitm_adv_jitter_timer_loop',
    'mitm_adv_jitter_timer_count',
    'mitm_adv_cap_timer_on',
    'mitm_adv_cap_timer_ms',
    'mitm_adv_cap_timer_loop',
    'mitm_adv_cap_timer_count',
    'mitm_adv_loss_timer_on',
    'mitm_adv_loss_timer_ms',
    'mitm_adv_loss_timer_loop',
    'mitm_adv_loss_timer_count',
]

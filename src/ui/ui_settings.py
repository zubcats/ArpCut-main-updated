...
# Qt UI — generated from ui_settings.ui (ZubCut)
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QtCore.QSize(400, 580))
        ...
        self.groupBox_keys.setMinimumSize(QtCore.QSize(0, 108))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.groupBox_keys.setFont(font)
        self.groupBox_keys.setObjectName("groupBox_keys")
        self.formLayout_keys = QtWidgets.QFormLayout(self.groupBox_keys)
        self.formLayout_keys.setObjectName("formLayout_keys")
        self.labelKeyKill = QtWidgets.QLabel(self.groupBox_keys)
        self.labelKeyKill.setObjectName("labelKeyKill")
        self.keySeqKill = QtWidgets.QKeySequenceEdit(self.groupBox_keys)
        self.keySeqKill.setObjectName("keySeqKill")
        self.formLayout_keys.addRow(self.labelKeyKill, self.keySeqKill)
        self.labelKeyLag = QtWidgets.QLabel(self.groupBox_keys)
        self.labelKeyLag.setObjectName("labelKeyLag")
        self.keySeqLag = QtWidgets.QKeySequenceEdit(self.groupBox_keys)
        self.keySeqLag.setObjectName("keySeqLag")
        self.formLayout_keys.addRow(self.labelKeyLag, self.keySeqLag)
        self.labelKeyDupe = QtWidgets.QLabel(self.groupBox_keys)
        self.labelKeyDupe.setObjectName("labelKeyDupe")
        self.keySeqDupe = QtWidgets.QKeySequenceEdit(self.groupBox_keys)
        self.keySeqDupe.setObjectName("keySeqDupe")
        self.formLayout_keys.addRow(self.labelKeyDupe, self.keySeqDupe)
        self.gridLayout.addWidget(self.groupBox_keys, 3, 0, 1, 4)
        ...
        self.gridLayout.addWidget(self.groupBox_4, 0, 0, 1, 4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_keys.setTitle(_translate("MainWindow", "Keyboard shortcuts"))
        self.labelKeyKill.setText(_translate("MainWindow", "Kill toggle (main window)"))
        self.labelKeyLag.setText(_translate("MainWindow", "Lag Switch panel"))
        self.labelKeyDupe.setText(_translate("MainWindow", "Dupe panel"))

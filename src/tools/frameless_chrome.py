...
from PyQt5.QtGui import QCursor, QFont, QIcon, QPainterPath, QPixmap, QRegion
...
def register_window_surface_effects(window_widget):
    """Translucent client + DWM hints; Qt mask provides rounded clip on frameless windows."""

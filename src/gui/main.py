...
class ElmoCut(FramelessResizableMixin, QMainWindow, Ui_MainWindow):
    ...
    def _apply_inline_panel_styles(self):
        ...
        panel_style = (
            ...
            ' image: none; border: none; width: 0; height: 0; margin: 0 1px 1px 1px;'
            ' border-left: 4px solid transparent; border-right: 4px solid transparent;'
            ' border-bottom: 5px solid #9a9a9a; }'
            'QGroupBox#groupLagInline QSpinBox::down-arrow, QGroupBox#groupDupeInline QSpinBox::down-arrow {'
            ' image: none; border: none; width: 0; height: 0; margin: 1px 1px 0 1px;'
            ' border-left: 4px solid transparent; border-right: 4px solid transparent;'
        ...
        percent_style = (
            ...
            f' background-color: {sel_bg}; border: 1px solid {sel_bg}; }}'
            'QSpinBox#spinPercentCutMain::up-arrow { image: none; border: none; width: 0; height: 0;'
            ' margin: 0 1px 1px 1px; border-left: 4px solid transparent; border-right: 4px solid transparent;'
            ' border-bottom: 5px solid #9a9a9a; }'
            'QSpinBox#spinPercentCutMain::down-arrow { image: none; border: none; width: 0; height: 0;'
            ' margin: 1px 1px 0 1px; border-left: 4px solid transparent; border-right: 4px solid transparent;'
            ' border-top: 5px solid #9a9a9a; }'

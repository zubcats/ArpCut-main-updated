...
class ElmoCut(FramelessResizableMixin, QMainWindow, Ui_MainWindow):
    ...
    def _apply_inline_panel_styles(self):
        ...
        panel_style = (
            ...
            f' width: 14px; height: 14px; border: 1px solid {admin_bg}; background-color: transparent; margin: 0px; }}'
            f'QGroupBox#groupLagInline QCheckBox::indicator:hover, QGroupBox#groupDupeInline QCheckBox::indicator:hover {{ border: 1px solid {sel_bg}; }}'
            f'QGroupBox#groupLagInline QCheckBox::indicator:checked, QGroupBox#groupDupeInline QCheckBox::indicator:checked {{ background-color: {sel_bg}; border: 1px solid {admin_bg}; }}'

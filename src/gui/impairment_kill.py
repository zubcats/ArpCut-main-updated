...
class ImpairmentKillMixin:
    ...
    def _apply_lan_kill_full(self, device, mac, _mark):
        """Full LAN Kill ON: adapter reconcile, MITM prereqs, poison + forwarder."""
        ...
        try:
            ...
            if turn_on:
                ...
                if victim:
                    ...
                    self._schedule_kill_off_reinforce(mac, my_seq, 1500)
                    self._schedule_kill_off_reinforce(mac, my_seq, 4000)
                    try:
